...
class GitHubDirectClient:
    ...
    def get_category_folder(self, ai_category: str) -> str:
        """AI 分類結果から適切なフォルダー名を取得"""
        category_mapping = {
            "finance": "Finance",
            "expense": "Finance",
            "money": "Finance",
            ...
            "education": "Learning",
            "idea": "Quick Notes",
            "brainstorm": "Quick Notes",
            "inspiration": "Quick Notes",
            "work": "Work",
            "project": "Work",
            "meeting": "Work",
        }

        # AI カテゴリを小文字に変換してマッピング
        ai_category_lower = ai_category.lower()

        # 直接マッピング
        if ai_category_lower in category_mapping:
            return category_mapping[ai_category_lower]
